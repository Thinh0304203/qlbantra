...
// Truy vấn sản phẩm theo category_id nếu có, hoặc lấy tất cả sản phẩm
if ($category_id > 0) {
            ...
            ?>
                    <form action="" method="post" class="box">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="../chucnang/chitietsp.php?id=<?php echo $fetch_products['id_sanpham']; ?>" class="btn"><i class="fas fa-eye"></i></a>
                        </div>
                    </form>
            <?php
                }
